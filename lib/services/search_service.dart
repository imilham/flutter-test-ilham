...
class SearchService {
  ...
  final List<String> _mockData = ['Flutter Development', 'Dart Programming', 'Mobile App Development', 'iOS Development', 'Android Development', 'Cross-platform Development', 'UI/UX Design', 'State Management', 'Backend Integration', 'API Development', 'Testing Strategies', 'Performance Optimization'];
  ...
  Future<List<String>> searchProducts(String query) async {
    try {
      ...
      return _mockData.where((item) => item.toLowerCase().contains(query.toLowerCase())).toList();
    } catch (e) {
